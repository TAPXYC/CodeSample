...
namespace Tapxyc.Drawler
{
    ...
    /// <para></para>
    ///[MenuItem("Vegma/VegmaWindow")]
    /// <para></para>
    ///public static void ShowWindow()
    /// <para></para>
    ///{
    /// <para></para>
    ///    EditorWindow.GetWindow(typeof(VegmaWindow));
    /// <para></para>
    ///}
    /// </summary>
    public abstract class BaseWindowDrawler : EditorWindow
    {
        protected GUIStyle headerStyle;
        protected GUIStyle subTittle;
        protected GUIStyle errorStyle;
        protected GUIStyle messageStyle;
        protected Color impotantFieldWrongColor;
            ...
            if (isImportant)
            {
                if (property.propertyType == SerializedPropertyType.ObjectReference)
                    if (property.objectReferenceValue == null)
                    {
                        ...
                        GUI.color = impotantFieldWrongColor;
                    }
            }
        ...
        protected abstract void OnEnableCall(SerializedObject serializedObject);
        protected abstract void OnGUIDraw(SerializedObject serializedObject);
    }
}
#endif